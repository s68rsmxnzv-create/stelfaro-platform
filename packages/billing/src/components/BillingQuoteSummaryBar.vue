...
<template>
  <div class="pointer-events-none fixed inset-x-0 bottom-[calc(3.5rem+env(safe-area-inset-bottom))] z-40 px-0 md:bottom-3 md:z-30 md:px-4">
    <section class="pointer-events-auto mx-auto grid max-w-4xl grid-cols-[minmax(0,1fr)_auto] items-center gap-3 rounded-t-2xl border border-line bg-surface-raised/95 px-4 pb-3 pt-3 text-text shadow-xl shadow-surface backdrop-blur md:flex md:flex-wrap md:justify-between md:gap-2 md:rounded-lg md:px-3 md:py-2">
