...
defineEmits<{ reset: []; refreshPhotos: []; print: [] }>();
const qr = ref('');
const whatsappUrl = computed(() => workshopWhatsAppUrl(props.order));
